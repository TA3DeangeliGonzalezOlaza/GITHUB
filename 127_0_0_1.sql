...
(13, 9, 'el grone', 2, 5, '12313', '', '', '', 'nuevo', '2017-05-30', 'permuta', 'ARTE', 0),
(14, 2, 'Prueba articulo', 123, 234, 'Prueba para ver si queda premium', '', '', '', 'nuevo', '2017-05-30', 'nopermuta', 'MODA', 0);
...
INSERT INTO `transaccion` (`id_trans`, `id_usut`, `id_pubt`, `precio_finalt`, `fechat`, `cantidad`, `calificaciont`, `pago_comision`) VALUES
(1, 2, 11, 500, '0000-00-00', 1, 0, 0),
(2, 2, 11, 500, '0000-00-00', 1, 0, 0),
(3, 2, 11, 500, '0000-00-00', 1, 0, 0),
(4, 2, 9, 500, '0000-00-00', 1, 0, 0),
(5, 2, 9, 500, '0000-00-00', 1, 0, 0),
(6, 2, 10, 500, '0000-00-00', 1, 0, 0),
(7, 1, 12, 10, '0000-00-00', 5, 0, 0);
...
('root', '[{\"db\":\"e-comerce\",\"table\":\"comenta\"},{\"db\":\"e-comerce\",\"table\":\"usuario\"},{\"db\":\"e-comerce\",\"table\":\"publicacion\"},{\"db\":\"e-comerce\",\"table\":\"persona\"},{\"db\":\"e-comerce\",\"table\":\"transaccion\"},{\"db\":\"e-comerce\",\"table\":\"permuta\"},{\"db\":\"e-commercer\",\"table\":\"persona\"},{\"db\":\"e-commercer\",\"table\":\"permuta\"},{\"db\":\"e-commercer\",\"table\":\"comenta\"},{\"db\":\"e-commercer\",\"table\":\"PERMUTA\"}]');
...
('root', 'e-comerce', 'publicacion', '{\"sorted_col\":\"`publicacion`.`categoria_pub`  DESC\"}', '2017-05-29 23:50:20');
